...
@interface ObjTempViewController ()

@end

@implementation ObjTempViewController
...
-(void)rangeUpdate {
    ...
    self.plotSpace.yRange = [CPTPlotRange plotRangeWithLocation:CPTDecimalFromFloat(ymin - 5)
                                                         length:CPTDecimalFromFloat(ymax + 5)];
